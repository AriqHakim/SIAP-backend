...
export class Kelas1680928192303 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE \`kelas\` (\`id\` varchar(36) NOT NULL, \`judul\` varchar(50) NOT NULL, \`deskripsi\` varchar(50) NOT NULL, \`kode\` varchar(6) NOT NULL, \`asisten_id\` varchar(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
